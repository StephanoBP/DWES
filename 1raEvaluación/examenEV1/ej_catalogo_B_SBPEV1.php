...
<html lang="es"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		<!-- Se puede quitar código en la parte del navegador, de Gestionar, de Filtros y de Resultados -->
			...
			<div id="tables" style="float:left; width:30%; ">
				...
				<fieldset>
					...
					<table>
						<tbody>
							<?php
							$gestion=array('productos','proveedores','usuarios');
							$elto="";
						...
						<tbody>
							<?php
								...
								foreach ($resultados as $datos){
									...
									if($datos['cod']==22||$datos['cod']==23||$datos['cod']==31||$datos['cod']==33){
